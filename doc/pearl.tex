...
our target is smaller of larger than the value we just read.
...
the value 11 in a sorted array.
%
...
next step.
%
We then read the value in the middle of the left half of the array, obtain 5
